...
export const CompanyAdminTemplate: FC = () => {
  ...
  return (
    <div className={'flex flex-col min-h-dvh max-w-[100dvw] h-full'} id={'main'}>
      ...
      <main className={'flex w-full '} style={{ minHeight: getHeight() }}>
        ...
        <div
          className={
            'flex flex-col w-full text-gray-900 h-full px-4 overflow-x-hidden tablet:px-8 py-8 laptop:pl-10 laptop:pr-[120px] laptop:py-8 desktop:laptop:py-14'
          }
