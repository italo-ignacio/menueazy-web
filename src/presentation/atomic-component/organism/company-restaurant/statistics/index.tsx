...
export const CompanyRestaurantStatistics: FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className={'flex flex-col gap-2 w-full min-w-max px-4'}>
        <h3>{t('restaurant.costs')}</h3>

        <div className={'flex gap-3 items-center'}>
          <h2 className={'font-bold text-[26px] pl-1'}>
            {currencyData[currency].symbol}102.450,89
          </h2>
      ...
      <div className={'flex flex-col gap-2 w-full min-w-max px-4'}>
        <h3>{t('restaurant.totalRestaurants')}</h3>

        <div className={'flex gap-3 items-center'}>
          <h2 className={'font-bold text-[26px] pl-1'}>6</h2>
        </div>
      </div>

      <div className={'flex flex-col gap-2 w-full min-w-max px-4'}>
        <h3>{t('restaurant.openingRestaurants')}</h3>

        <div className={'flex gap-3 items-center'}>
          <h2 className={'font-bold text-[26px] pl-1'}>4</h2>
        </div>
      </div>
    </div>
  );
